<?php
/* Smarty version 3.1.28, created on 2016-07-11 00:39:29
  from "C:\xampp\htdocs\serra\financeiro\app\viewer\Exit\view.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.28',
  'unifunc' => 'content_578314f1af9480_36755794',
  'file_dependency' => 
  array (
    '3f5ccf7925832f74d4a5ed037954d8e4f958c08b' => 
    array (
      0 => 'C:\\xampp\\htdocs\\serra\\financeiro\\app\\viewer\\Exit\\view.tpl',
      1 => 1468208367,
      2 => 'file',
    ),
  ),
...
function content_578314f1af9480_36755794 ($_smarty_tpl) {
?>
<div class="row">
    <div class="col-sm-12">
...
<div class="row">
    <form action="exit/view" method="post" class="ignore-wait">
...
<div class="row">
    <div class="col-md-12 table-responsive">
        <table class="table table-bordered table-hover datatable">
            ...
            <tbody>
                <?php
$_from = $_smarty_tpl->tpl_vars['exits']->value;
if (!is_array($_from) && !is_object($_from)) {
settype($_from, 'array');
}
$__foreach_exit_3_saved_item = isset($_smarty_tpl->tpl_vars['exit']) ? $_smarty_tpl->tpl_vars['exit'] : false;
$_smarty_tpl->tpl_vars['exit'] = new Smarty_Variable();
$__foreach_exit_3_total = $_smarty_tpl->smarty->ext->_foreach->count($_from);
if ($__foreach_exit_3_total) {
foreach ($_from as $_smarty_tpl->tpl_vars['exit']->value) {
$__foreach_exit_3_saved_local_item = $_smarty_tpl->tpl_vars['exit'];
?>
                    <tr>
                        <?php if ($_smarty_tpl->tpl_vars['exit']->value->get('id_client') == NULL) {?>
                            <?php $_smarty_tpl->tpl_vars["client"] = new Smarty_Variable("-", null);
$_smarty_tpl->ext->_updateScope->updateScope($_smarty_tpl, "client", 0);?>
                        <?php } else { ?>
                            <?php $_smarty_tpl->tpl_vars["client"] = new Smarty_Variable($_smarty_tpl->tpl_vars['exit']->value->get('id_client',true)->get('name'), null);
$_smarty_tpl->ext->_updateScope->updateScope($_smarty_tpl, "client", 0);?>
                        <?php }?>
                        <td><?php echo $_smarty_tpl->tpl_vars['exit']->value->get('id');?>
</td>
                        <td><?php echo $_smarty_tpl->tpl_vars['exit']->value->get('date',true);?>
</td>
                        <td><?php echo $_smarty_tpl->tpl_vars['exit']->value->get('id_type',true)->get('name');?>
</td>
                        <td><?php echo $_smarty_tpl->tpl_vars['client']->value;?>
</td>
                        <td><?php echo $_smarty_tpl->tpl_vars['exit']->value->get('description');?>
</td>
                        <td>R$<?php echo $_smarty_tpl->tpl_vars['exit']->value->get('value',true);?>
</td>
                    </tr>
                <?php
$_smarty_tpl->tpl_vars['exit'] = $__foreach_exit_3_saved_local_item;
}
}
if ($__foreach_exit_3_saved_item) {
$_smarty_tpl->tpl_vars['exit'] = $__foreach_exit_3_saved_item;
}
?>
            </tbody>
        </table>
