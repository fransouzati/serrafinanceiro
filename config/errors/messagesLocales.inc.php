<?php
    switch (_LOCALE) {
        case 'en':
            ...
            // Delete
            define('_DELETE_SUCCESS', 'Data deleted.');
            define('_DELETE_ERROR', 'An error occurred. Please, try again.');
        ...
        case 'ptbr':
            ...
            // Deletar
            define('_DELETE_SUCCESS', 'Dados deletados.');
            define('_DELETE_ERROR', 'Um erro ocorreu. Por favor, tente novamente.');

            // Erro
            define('_PHP_ERROR', 'Ops! Um erro ocorreu. Por favor, contate a administração do sistema.');

            // User
            define('_USER_EXISTS', 'Usuário já cadastrado no sistema.');
